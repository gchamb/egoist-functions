...
import { user, progressEntry, progressReport, progressVideo, revenueCatSubscriber } from "./schema";
...
export const revenueCatSubscriberRelations = relations(revenueCatSubscriber, ({one}) => ({
	user: one(user, {
